...
public class tableTheme extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "Quizz.db";
    public static final String TABLE_NAME ="THEME_LIEU_GEO";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " +  TABLE_NAME + "(ID INTEGER PRIMARY KEY AUTOINCREMENT, LIBELLE TEXT)");
    }
